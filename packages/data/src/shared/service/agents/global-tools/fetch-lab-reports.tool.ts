/**
 * Fetch Lab Reports Tool — Global tool for all agents
 *
 * Fetches the user's stored lab report records from Firestore.
 * Available to any agent that needs to check existing lab results.
 */
