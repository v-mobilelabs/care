...
export interface BuildContextParams {
  ...
  minScore?: number;
  /**
   * Enable reranking via Vertex AI Ranking API (default: true).
  ...
  rerankTopK?: number;
  /** Minimum rerank score 0-1 for Vertex AI Ranking API (default: 0.5) */
...
export class RAGContextBuilderService {
   ...
   * 2. Vertex AI Ranking API scores for relevance
