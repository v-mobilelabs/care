            ...
            <Group justify="space-between" mb="xs" wrap="nowrap" align="flex-start">
                ...
                <Group gap={6} wrap="nowrap">
                    ...
                    <Menu withinPortal position="bottom-end">
                        <Menu.Target>
                            <ActionIcon variant="subtle" color="gray" aria-label="Insurance card options">
            ...
            <Stack gap={4} mt="xs">
                ...
                {(record.effectiveDate || record.expirationDate) && (
                    <Group gap="xs">
                        ...
                        <Text size="xs" fw={600}>
                            {record.effectiveDate ? <DateText date={record.effectiveDate} /> : "—"}
                            {"  "}
                            {record.expirationDate ? <DateText date={record.expirationDate} /> : "ongoing"}
                        </Text>
                    </Group>
                )}
            </Stack>
