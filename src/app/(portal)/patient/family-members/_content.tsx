                ...
                <Group justify="space-between" align="flex-start" wrap="nowrap">
                    ...
                    >
                        <Tooltip label="Edit" withArrow position="top">
                            <ActionIcon variant="subtle" color="gray" aria-label="Edit member" onClick={() => onEdit(dep)}>
                                <IconEdit size={18} />
                            </ActionIcon>
                        </Tooltip>
                        <Tooltip label="Remove" withArrow position="top">
                            <ActionIcon variant="subtle" color="red" aria-label="Remove member" onClick={() => onDelete(dep)}>
                                <IconTrash size={18} />
                            </ActionIcon>
                        </Tooltip>
                    </Group>
