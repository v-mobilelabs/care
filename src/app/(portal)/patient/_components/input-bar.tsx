...
import { useMic } from "@/app/(portal)/patient/_hooks/use-mic";
import { useLiveSpeech } from "@/app/(portal)/patient/_hooks/use-live-speech";
import { LiveOverlay } from "@/app/(portal)/patient/_components/live-overlay";
                        ...
                        <Group justify="space-between" px="sm" pb="sm" pt={4} gap={4}>
                            <Group gap={2}>
                                ...
                                <Tooltip label={isListening ? "Stop recording" : "Use microphone"} withArrow position="top">
                                    <motion.div
                                        animate={isListening ? { boxShadow: ["0 0 0 0 rgba(250, 82, 82, 0.55)", "0 0 0 7px rgba(250, 82, 82, 0)"] } : {}}
                                        transition={isListening ? { duration: 1.2, ease: "easeInOut", repeat: Infinity } : undefined}
                                    >
