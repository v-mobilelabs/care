...
import { useCreditsQuery, useProfileQuery } from "@/app/(portal)/patient/_query";
...
import { AppsModal } from "@/app/(portal)/patient/_components/apps-modal";
import { Credits } from "@/ui/credits";

interface ChatHeaderProps { }

export function ChatHeader({ }: Readonly<ChatHeaderProps>) {
    const { user } = useAuth();
                ...
                <Group gap={8}>
                    ...
                    <Menu position="bottom-end" withArrow offset={8}>
                        ...
                        <Menu.Dropdown miw={200}>
                            ...
                            <Menu.Item leftSection={<IconUsersGroup size={16} />} onClick={() => router.push("/patient/family-members")}>Family</Menu.Item>
                            <Menu.Divider />
