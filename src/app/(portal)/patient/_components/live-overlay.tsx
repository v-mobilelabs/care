                ...
                <motion.div
                    animate={
                        livePhase === "speaking"
                            ? {
                                  boxShadow: [
                                      "0 0 0 0 rgba(32, 201, 151, 0.45), 0 0 0 0 rgba(32, 201, 151, 0.2)",
                                      "0 0 0 40px rgba(32, 201, 151, 0), 0 0 0 80px rgba(32, 201, 151, 0)",
                                  ],
                              }
                            : livePhase === "listening"
                              ? { scale: [1, 1.09, 1], opacity: [1, 0.82, 1] }
                              : livePhase === "thinking"
                                ? { scale: [1, 1.09, 1], opacity: [1, 0.82, 1] }
                                : {}
                    }
                    transition={
                        livePhase === "speaking"
                            ? { duration: 1.5, ease: "easeOut", repeat: Infinity }
                            : livePhase === "listening"
