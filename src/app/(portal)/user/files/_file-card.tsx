    ...
    return (
        <Group justify="flex-end" mt="sm">
            <Button
                ...
                onClick={() => trackEvent({ name: "health_record_exported", params: { artifact_type: "file" } })}
...
function ImagePreview({ file }: Readonly<{ file: FileRecord }>) {
    ...
    return (
        <Box>
            ...
            <DownloadButton url={downloadUrl} name={file.name} />
        </Box>
    );
}
...
function PdfPreview({ file }: Readonly<{ file: FileRecord }>) {
    ...
    return (
        <Box>
            {loading && <PreviewLoader />}
            <Box
                component="iframe" src={downloadUrl} title={file.name}
                        ...
                        <>
                            ...
                            <Tooltip label="Download" withArrow>
                                <ActionIcon size={24} variant="subtle" color="primary"
                                    ...
                                    onClick={() => trackEvent({ name: "health_record_exported", params: { artifact_type: "file", artifact_id: file.id } })}>
