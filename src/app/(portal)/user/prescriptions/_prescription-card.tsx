...
import { type PrescriptionRecord } from "@/app/(portal)/user/_query";
                            ...
                            <>
                                ...
                                <Tooltip label="Download" withArrow>
                                    <ActionIcon
                                        ...
                                        onClick={() => trackEvent({ name: "health_record_exported", params: { artifact_type: "prescription", format: "pdf", artifact_id: file.id } })}
                                    >
