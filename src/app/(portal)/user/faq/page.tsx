...
const SECTIONS = [
    ...
    },
    {
        ...
        items: [
            {
                q: "What are credits?",
                a: "Credits are part of your monthly CareAI usage allowance. Your account includes 100 credits per month, and each message you send to CareAI costs 1 credit.",
            },
            {
                q: "When do my credits reset?",
                a: "Credits reset automatically each month. You don't need to do anything — your balance refreshes when a new monthly usage cycle begins.",
            },
            {
                q: "Why a credit system?",
                a: "The credit system helps us keep CareAI reliable while supporting more advanced health workflows such as structured assessments, file analysis, and record-aware guidance.",
            },
            {
                q: "Can I get more credits?",
                a: "We are working on expanded plans with higher monthly usage limits. Stay tuned for announcements.",
            },
        ],
    },
    {
