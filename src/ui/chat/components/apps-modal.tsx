...
const HEALTH_APPS: AppDef[] = [
    {
        ...
        label: "Assessments",
        href: "/chat/assessments",
        match: (p) => p.startsWith("/chat/assessments"),
    },
    {
        icon: <IconHeartbeat size={ICON_SIZE} style={{ color: APP_ICON_COLOR }} stroke={1.5} />,
        label: "Health",
        href: "/chat/health-records",
        match: (p) => p.startsWith("/chat/health-records"),
    },
    {
        icon: <IconSalad size={ICON_SIZE} style={{ color: APP_ICON_COLOR }} stroke={1.5} />,
        label: "Diet Plans",
        href: "/chat/diet-plans",
        match: (p) => p.startsWith("/chat/diet-plans"),
    },
    {
        icon: <IconNotes size={ICON_SIZE} style={{ color: APP_ICON_COLOR }} stroke={1.5} />,
        label: "Summary",
        href: "/chat/patient-summary",
        match: (p) => p.startsWith("/chat/patient-summary"),
    },
];
...
const ACCOUNT_APPS: AppDef[] = [
    ...
    },
    {
        ...
        label: "Usage",
        href: "/chat/usage",
        match: (p) => p.startsWith("/chat/usage"),
    },
    {
