/**
 * Get Patient Tool — Fetch the patient's merged profile + health snapshot.
 *
 * Returns base identity/profile facts plus patient health data so the patient
 * agent can answer simple self-retrieval questions in a single tool call.
 */
